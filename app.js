...
mongoose.connect(`mongodb://${process.env.DB_USER}:${process.env.DB_ADMIN_PASSWORD}@ds343718.mlab.com:43718/mern-twitter`, { useNewUrlParser: true, useUnifiedTopology: true, useFindAndModify: false })
  .then(() => {
